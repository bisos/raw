...
####+END:
    ...
    csParams.parDictAdd(
        parName='freshDeb',
        parDescription="Fresh Debian Image to Start From. Typically a Combination of Version and Net/Desktop",
        parDataType=None,
        parDefault='13',
        parChoices=["12", "13", "12Net"],
        argparseShortOpt=None,
        argparseLongOpt='--freshDeb',
    )
    csParams.parDictAdd(
        parName='platformModel',
        parDescription="Platform Model is Box, Guest, Container.docker.confined",
        parDataType=None,
        parDefault=None,
        parChoices=["confined", "sysd-priv", "sysd-podman"],
        argparseShortOpt=None,
        argparseLongOpt='--platformModel',
    )
    csParams.parDictAdd(
        parName='instance',
        parDescription="Rebuild at instance",
        parDataType=None,
        parDefault=None,
        parChoices=["instance",],
        argparseShortOpt=None,
        argparseLongOpt='--instance',
    )
    csParams.parDictAdd(
        parName='startState',
        parDescription="Expect the startSte at startTarget",
        parDataType=None,
        parDefault="blank",
        parChoices=["blank",],
        argparseShortOpt=None,
        argparseLongOpt='--startState',
    )
    csParams.parDictAdd(
        parName='endResult',
        parDescription="Which End-Result is Desired (Targeted)",
        parDataType=None,
        parDefault="rawBisos-base",
        parChoices=["rawBisos-base", "rawBisos-caps", "raw-bisos-dev"],
        argparseShortOpt=None,
        argparseLongOpt='--endResult',
    )
    csParams.parDictAdd(
        parName='endVerify',
        parDescription="After endResult, to what extent will we verify",
        parDataType=None,
        parDefault=None,
        parChoices=["basic",],
        argparseShortOpt=None,
        argparseLongOpt='--endVerify',
    )
    csParams.parDictAdd(
        parName='endNotify',
        parDescription="After endVerify, notify status and results",
        parDataType=None,
        parDefault=None,
        parChoices=None,
        argparseShortOpt=None,
    ...
    csParams.parDictAdd(
        parName='noCache',
        parDescription="No Cache. When True, build the image with --no-cache (ignore layer cache)",
        parDataType=None,
        parDefault=None,
        parChoices=[True,],
        argparseShortOpt=None,
